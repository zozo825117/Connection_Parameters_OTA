...
const CYBLE_HIDSS_T cyBle_hidss[0x01u] = {
    {
        ...
        0x04u, /* Number of report characteristics */ 
        cyBle_hids1ReportArray, /* Information about report characteristics */ 
        {
            {
                0x0016u, /* Handle of the Report characteristic value */ 
        ...
        0x0010u, /* Handle of the Report Map characteristic */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Report Map External Report Reference descriptor */ 
        0x0012u, /* Handle of the HID Information characteristic */ 
        0x0014u, /* Handle of the HID Control Point characteristic */ 
    },
};
