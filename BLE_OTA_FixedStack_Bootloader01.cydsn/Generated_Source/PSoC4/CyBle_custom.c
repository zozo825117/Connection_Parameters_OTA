...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Custom Service service */
    {
        0x000Cu, /* Handle of the Custom Service service */ 
        {
            ...
            /* Now ML characteristic */
            {
                0x000Eu, /* Handle of the Now ML characteristic */ 
            ...
            /* Tmp ML characteristic */
            {
                0x0012u, /* Handle of the Tmp ML characteristic */ 
            ...
            /* ReCalibation characteristic */
            {
                0x0016u, /* Handle of the ReCalibation characteristic */ 
            ...
            /* Button updata characteristic */
            {
                0x0019u, /* Handle of the Button updata characteristic */ 
